const registerBtn = document.getElementById("creat-btn");
...
/*
check input value if match regExp and add claass succes or error AND icon valid
*/

//for username input
const inputName = document.getElementById("username");
const allIcons = document.getElementsByClassName("icon-checkmark2")[0];
inputName.addEventListener("keyup", (eo) => {
  ...
  //enable register button if all input are valid inputName inputEmail inputPass pswRepeat
const active = () => {
  if (
